...
COPY html (id, field_id, text, page, type) FROM stdin;
3	masthead-p	Captain Calamari is the most badass Cephalopoda that ever had tentacles. He eats only the finest caviar and drinks only the finest of sharks blood	home	Tagline
5	about-p	He is the most interesting mollusc in the East Atlantic	home	Tagline
2	masthead-h1	Welcome to Captain Calamari's Crusade	home	Header
4	about-h2	What is it about Captain Calamari?	home	Header
\.
...
SELECT pg_catalog.setval('html_id_seq', 5, true);
...
ueAXZnrk7GTKe2z3KrdFmepidQ98rrZX	{"cookie":{"originalMaxAge":null,"expires":null,"httpOnly":true,"path":"/"},"passport":{"user":{"id":1,"name":"sdot","username":"st","password":"$2a$10$5WLGoSmDP7NwZLDThzI6lOUMZMKZMNaDbgFdfQcr2X0Ahjb0YV9rK"}}}	2020-03-22 20:15:23
\.
